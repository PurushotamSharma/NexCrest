    ...
    <div className="bg-black text-white py-16 px-8">
      <div className="container mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">About Wizbloom</h2>
          <p className="text-lg">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-12">
          ...
          <div className="md:w-1/2 mt-8 md:mt-0 md:ml-8">
            ...
            <p className="text-lg mb-8">
              At <strong>Wizbloom</strong>, our mission is to help businesses of all sizes establish a strong and effective online presence through our innovative web development solutions. We aim to deliver customized and high-quality digital products that meet the specific needs of each client, while also providing excellent customer service and support.
            </p>
            <h3 className="text-3xl font-semibold mb-4">Our Vision</h3>
            <p className="text-lg">
              Our vision at <strong>Wizbloom</strong> is to become a leading web development company that is recognized for our expertise, innovation, and commitment to client success. We strive to empower businesses with the tools they need to thrive in the digital age, while also forming a collaborative and growth-oriented company culture that values creativity, integrity, and excellence.
            </p>
          </div>
        </div>
