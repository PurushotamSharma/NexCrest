...
import developmentImage from '../../assests/deployment1.png'; // Replace with the actual path to your image
  ...
  return (
    <div className="container mx-auto px-4 py-8 text-white">
      ...
      <header className="text-center mb-16">
        <h1 className="text-5xl font-extrabold mb-4 text-orange-500 fade-in-left">Website Development</h1>
        <p className="text-lg text-gray-300 fade-in-right">
          Creating beautiful, responsive, and functional websites tailored to your business needs.
        </p>
      </header>

      <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <div className="fade-in-left">
          <h2 className="text-3xl font-semibold mb-4 text-white">Our Expertise in Website Development</h2>
          <p className="text-lg text-gray-300 mb-6">
            We build responsive and dynamic websites that are designed to captivate and engage your audience. Our team ensures
            your website is optimized for performance and user experience.
          </p>
          <ul className="space-y-2 mb-6">
            {['Responsive Design', 'SEO Optimization', 'E-commerce Solutions', '24/7 Support'].map((item, index) => (
        ...
        <div className="fade-in-right">
          <img src={developmentImage} alt="Website Development" className="w-full rounded-md shadow-lg" />
        </div>
      </section>
