...
import hostingImage from '../../assests/hosting.png'; // Replace with the actual path to your image
    ...
    <div className="container mx-auto px-4 py-8 text-white">
      <style>
        {`
          ...
          .gradient-bg {
            background: linear-gradient(135deg, #ff0077, #00c6ff);
            padding: 20px;
            border-radius: 10px;
          ...
          .section-header {
            font-size: 2.5rem;
            font-weight: bold;
            background: linear-gradient(90deg, #ff0077, #00c6ff);
      ...
      <header className="text-center mb-16">
        <h1 className="text-5xl font-extrabold mb-4 text-blue-500 fade-in-left">Domain & Hosting</h1>
        <p className="text-lg text-gray-300 fade-in-right">
          Secure and reliable domain and hosting solutions to boost your online presence.
        </p>
      </header>

      <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <div className="fade-in-left">
          <h2 className="text-3xl font-semibold mb-4 text-white">Creative Solutions for Your Business</h2>
          <p className="text-lg text-gray-300 mb-6">
            We provide reliable domain registration and hosting solutions to ensure your business has a strong online presence.
            Our services include domain registration, website hosting, email hosting, and more. Our support team is available 24/7
            to assist you with any issues.
          </p>
          <ul className="space-y-2 mb-6">
            {['Domain Registration', 'Website Hosting', 'Email Hosting', '24/7 Support'].map((item, index) => (
          ...
          <div>
            <Link to="/contact" className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition duration-300 transform hover:scale-105">
              Get Free Consultation Now!
            </Link>
          </div>
        </div>
        <div className="fade-in-right">
          <img src={hostingImage} alt="Hosting" className="w-full rounded-md shadow-lg" />
        </div>
      </section>
