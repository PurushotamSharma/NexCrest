...
import cloudMigrationImage from '../../assests/mig.png'; // Replace with the actual path to your image
  ...
  return (
    <div className="container mx-auto px-4 py-8 text-white">
      ...
      <header className="text-center mb-16">
        <h1 className="text-5xl font-extrabold mb-4 text-blue-400 fade-in-left">Cloud Migration</h1>
        <p className="text-lg text-gray-300 fade-in-right">
          Seamlessly migrate your infrastructure to the cloud with our expert solutions.
        </p>
      </header>

      <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <div className="fade-in-left">
          <h2 className="text-3xl font-semibold mb-4 text-white">Our Cloud Migration Expertise</h2>
          <p className="text-lg text-gray-300 mb-6">
            We provide comprehensive cloud migration services to ensure a smooth transition with minimal downtime.
          </p>
          <ul className="space-y-2 mb-6">
            {['AWS Migration', 'Azure Migration', 'Google Cloud Platform', '24/7 Support'].map((item, index) => (
        ...
        <div className="fade-in-right">
          <img src={cloudMigrationImage} alt="Cloud Migration" className="w-full rounded-md shadow-lg" />
        </div>
      </section>
