...
import appDevelopmentImage from '../../assests/app1.png'; // Replace with the actual path to your image
  ...
  return (
    <div className="container mx-auto px-4 py-8 text-white">
      ...
      <header className="text-center mb-16">
        <h1 className="text-5xl font-extrabold mb-4 text-green-400 fade-in-left">App Development</h1>
        <p className="text-lg text-gray-300 fade-in-right">
          Innovative and high-performance mobile app development to meet your business needs.
        </p>
      </header>

      <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <div className="fade-in-left">
          <h2 className="text-3xl font-semibold mb-4 text-white">Our Expertise in App Development</h2>
          <p className="text-lg text-gray-300 mb-6">
            We specialize in creating mobile applications that are both user-friendly and robust. Our team ensures
            your app performs seamlessly on all devices.
          </p>
          <ul className="space-y-2 mb-6">
            {['iOS Development', 'Android Development', 'Cross-Platform Solutions', '24/7 Support'].map((item, index) => (
          ...
          <div>
            <Link to="/contact" className="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600 transition duration-300 transform hover:scale-105">
              Get Free Consultation Now!
            </Link>
          </div>
        </div>
        <div className="fade-in-right">
          <img src={appDevelopmentImage} alt="App Development" className="w-full rounded-md shadow-lg" />
        </div>
      </section>
